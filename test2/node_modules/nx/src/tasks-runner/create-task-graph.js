...
class ProcessTasks {
    ...
    resolveConfiguration(project, target, configuration) {
        var _a, _b;
        const defaultConfiguration = (_b = (_a = project.data.targets) === null || _a === void 0 ? void 0 : _a[target]) === null || _b === void 0 ? void 0 : _b.defaultConfiguration;
        configuration !== null && configuration !== void 0 ? configuration : (configuration = defaultConfiguration);
