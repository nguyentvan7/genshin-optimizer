...
class TaskOrchestrator {
    ...
    runBatch(batch) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                const results = yield this.forkedProcessTaskRunner.forkProcessForBatch(batch, this.taskGraph);
                const batchResultEntries = Object.entries(results);
                return batchResultEntries.map(([taskId, result]) => (Object.assign(Object.assign({}, result), { task: Object.assign(Object.assign({}, this.taskGraph.tasks[taskId]), { startTime: result.startTime, endTime: result.endTime }), status: (result.success ? 'success' : 'failure'), terminalOutput: result.terminalOutput })));
            }
            catch (e) {
